...
class AuthNotify(object):
    ...
    @staticmethod
    def GetUserDataFromUsersId(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/AuthNotify/GetUserDataFromUsersId',
    ...
    def SetUserRole(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/AuthNotify/SetUserRole',
